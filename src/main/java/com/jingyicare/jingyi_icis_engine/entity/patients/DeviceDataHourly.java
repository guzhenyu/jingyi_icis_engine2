...
@Entity
@Table(
    name = "device_data_hourly",
    indexes = {
        @Index(name = "idx_device_data_hourly_device_id", columnList = "deviceId"),
        @Index(name = "idx_device_data_hourly_recorded_at", columnList = "recordedAt")
    }
)
public class DeviceDataHourly {
