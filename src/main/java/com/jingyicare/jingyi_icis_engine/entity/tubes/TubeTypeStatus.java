...
@Builder
@Entity
@Table(name = "tube_type_statuses", indexes = {
    @Index(name = "idx_tt_statuses_tube_type_id_status", columnList = "tube_type_id, status")
})
public class TubeTypeStatus {
    @Id
    ...
    private String status;  // 管道状态编码

    @Column(name = "name", nullable = false)
    private String name;  // 管道状态名称（展示）
